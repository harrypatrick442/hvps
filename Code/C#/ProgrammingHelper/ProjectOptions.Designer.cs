namespace ProgrammingHelper
{
    partial class ProjectOptions
    {
        ...
        private void InitializeComponent()
        {
            ...
            LabelProjectName.Size = new Size(96, 14);
            ...
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2850523F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2881622F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2850533F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2850523F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2850533F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2850533F));
            tableLayoutPanel2.RowStyles.Add(new RowStyle(SizeType.Percent, 14.2865734F));
            ...
            buttonCtlBracket.Location = new Point(0, 120);
            buttonCtlBracket.Margin = new Padding(0);
            buttonCtlBracket.Name = "buttonCtlBracket";
            buttonCtlBracket.Size = new Size(102, 22);
            ...
            _ButtonMonitor.Location = new Point(0, 100);
            _ButtonMonitor.Margin = new Padding(0);
            _ButtonMonitor.Name = "_ButtonMonitor";
            _ButtonMonitor.Size = new Size(102, 20);
            ...
            _ButtonFlash.Location = new Point(0, 80);
            _ButtonFlash.Margin = new Padding(0);
            _ButtonFlash.Name = "_ButtonFlash";
            _ButtonFlash.Size = new Size(102, 20);
            ...
            _ButtonSetup.Location = new Point(0, 40);
            _ButtonSetup.Margin = new Padding(0);
            _ButtonSetup.Name = "_ButtonSetup";
            _ButtonSetup.Size = new Size(102, 20);
            ...
            _ButtonBuild.Size = new Size(102, 20);
