...
public:
    ...
    // user convenience
    static void     selectReferenceVoltageChannel();
    static void     selectSnubberVoltageFeedbackChannel();
    static void     selectPrimaryCurrentFeedbackChannel();
    static void     selectPowerSupplyVoltageFeedbackChannel();

    static double   getCorrection();
    static double   getVoltage();
	static void measureNReadsPerSecond();
	static MonitorVoltageThresholdHandle* monitorVoltageThresholdWithNewPriorityTask(double initialVoltage, std::function<void(bool)> callback);
